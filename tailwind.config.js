  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'R-28': ['28px', { lineHeight: 'normal' }],
        'R-20': ['20px', { lineHeight: 'normal' }],
        'R-14': ['14px', { lineHeight: 'normal' }],
        'R-12': ['12px', { lineHeight: 'normal' }],
        'R-10': ['10px', { lineHeight: 'normal' }],
        'L-20': ['20px', { lineHeight: 'normal' }],
      },
      fontFamily: {
