    ...
    return(
        <div className="flex flex-col h-screen bg-white overflow-y-auto w-[393px] items-center px-10"> 
            ...
            <div className="w-full">
                <div className="rounded-xl border-neutral-400 w-full h-20 border-2 my-7 shadow-xl cursor-pointer">
                ...
                <div className="rounded-xl border-neutral-400 w-full h-20 border-2 my-3 shadow-xl cursor-pointer">
                    <div className="flex flex-row" onClick={() => {
