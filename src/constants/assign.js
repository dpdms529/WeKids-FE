export const assigndata = [
  {
    ...
    content: "금융 상품 가입 및 서비스 제공을 위해 귀하의 개인정보(이름, 연락처, 계좌정보 등)를 수집·이용합니다. 수집된 정보는 계약 이행 및 법령에 따라 보관됩니다.",
  },
  {
    title: "전자금융거래 이용 약관 동의 (필수)",
    content: "전자금융거래 이용 시 거래 내역 확인 및 안전한 서비스 제공을 위해 본 약관에 동의합니다. 약관은 서비스 이용 도중 언제든지 열람할 수 있습니다.",
  },
  {
    title: "상품 계약 관련 정보 제공 동의 (필수)",
    content: "가입하신 상품의 운영 및 관련 정보 제공을 위해 본 약관에 동의합니다. 상품 운영과 관련된 주요 변동 사항은 사전에 고지됩니다.",
  },
  {
    title: "마케팅 정보 수신 동의 (선택)",
    content: "최신 금융 상품 및 이벤트 소식을 SMS, 이메일 등으로 받아보시려면 본 약관에 동의해주세요. 동의를 거부하셔도 금융 상품 가입에는 문제가 없습니다.",
  },
];
